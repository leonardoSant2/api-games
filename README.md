...
# API de Games
API RESTful utilizada para o gerenciamento do estoque de Games disponíveis em uma loja.
...
#### Respostas
##### OK! 200
Requisição feita com sucesso. Você irá receber a listagem de todos os games.
Exemplo de resposta:
```
{
    "games": [
